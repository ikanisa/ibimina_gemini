                      ...
                      return (
                        <div key={member.memberId} className="grid grid-cols-12 px-6 py-4 items-center hover:bg-slate-50 transition-colors">
                          ...
                          <div className="col-span-1 text-center">
                             <span className={`inline-flex items-center justify-center px-2 py-1 rounded-full text-xs font-medium border ${
                                status === 'Paid' ? 'bg-green-50 text-green-700 border-green-100' :
                   ...
                   <tr key={member.memberId} className="hover:bg-slate-50">
                     ...
                     <td className="px-6 py-4">
                       <span className={`text-xs px-2 py-1 rounded border ${
                         member.role === 'Chairperson' ? 'bg-purple-50 text-purple-700 border-purple-100' :
                   ...
                   <div className="flex justify-between items-start">
                      <div className="flex gap-4">
                         <div className={`w-16 h-16 rounded-xl flex flex-col items-center justify-center border ${
                           meeting.status === 'Completed' ? 'bg-slate-50 border-slate-200' : 'bg-blue-50 border-blue-200 text-blue-700'
                         }`}>
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-medium border ${
                         meeting.status === 'Completed' ? 'bg-green-50 text-green-700 border-green-100' : 'bg-slate-100 text-slate-600 border-slate-200'
                      }`}>
                        {meeting.status}
                      </span>
                   </div>
