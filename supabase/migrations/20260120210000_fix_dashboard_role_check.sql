-- ============================================================================
-- Migration: Fix Dashboard RPC Role Check
-- Date: 2026-01-20
-- Purpose: Fix role check from 'PLATFORM_ADMIN' to 'ADMIN' to match actual DB values
-- ============================================================================

-- Drop and recreate with correct role check
...
begin
  ...
  -- Scope rules: ADMIN can view all or specific institution, everyone else sees only their institution
  -- Note: Role values in database are 'ADMIN' and 'STAFF' (not 'PLATFORM_ADMIN')
...
comment on function public.get_dashboard_summary is 
  'Returns dashboard summary. ADMIN can view all (null) or specific institution. STAFF sees only their own institution.';
